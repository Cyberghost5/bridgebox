...
@section('main')
    <main class="main">
        <header class="topbar">
            ...
            <div class="actions">
                <a class="btn ghost" href="{{ route('admin.assignments.submissions.index', $assignment) }}">Back to Submissions</a>
                @if ($submission->file_path)
                    <a class="btn ghost" href="{{ route('admin.assignments.submissions.download', [$assignment, $submission]) }}">Download File</a>
                @endif
