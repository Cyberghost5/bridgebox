    ...
    <main class="main">
        <header class="topbar">
            ...
            <div class="actions">
                ...
                <a class="btn ghost" href="{{ route('admin.assignments.export', array_merge($exportQuery, ['format' => 'csv'])) }}">Export CSV</a>
                <a class="btn ghost" href="{{ route('admin.assignments.export', array_merge($exportQuery, ['format' => 'xlsx'])) }}">Export Excel</a>
                <a class="btn ghost" href="{{ route('admin.assignments.export', array_merge($exportQuery, ['format' => 'pdf'])) }}">Export PDF</a>
