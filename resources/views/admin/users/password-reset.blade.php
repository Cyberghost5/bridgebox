...
<head>
    ...
    <title>Password Reset | BridgeBox</title>
    ...
    <div class="page">
        <aside class="sidebar">
            ...
            <nav class="nav">
                ...
                <a class="nav-item {{ $user->role === 'teacher' ? 'active' : '' }}" href="{{ route('admin.users.teachers.index') }}" aria-label="Manage teachers">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6">
                        <path d="M4 7h16"></path>
                ...
                <a class="nav-item {{ $user->role === 'student' ? 'active' : '' }}" href="{{ route('admin.users.students.index') }}" aria-label="Manage students">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6">
