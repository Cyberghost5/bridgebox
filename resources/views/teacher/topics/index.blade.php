    ...
    <main class="main">
        <header class="topbar">
            <div class="greeting">
                ...
                <h1>Topics</h1>
                <p class="subtext">Topics tied to your subjects and classes.</p>
            </div>
            <div class="actions">
                <a class="btn primary" href="{{ route('teacher.topics.create') }}">Add Topic</a>
            ...
            <div class="panel-body">
                <div class="table-toolbar">
                    <form class="search-form" method="get" action="{{ route('teacher.topics.index') }}">
                        ...
                        @if ($search)
                            <a class="btn ghost btn-small" href="{{ route('teacher.topics.index') }}">Clear</a>
                        @endif
                    </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <a class="btn ghost btn-small" href="{{ route('teacher.topics.edit', $topic) }}">Edit</a>
                                            <form method="post" action="{{ route('teacher.topics.delete', $topic) }}" data-confirm="Delete this topic?" style="display:inline-block;">
                                                @csrf
                                                @method('delete')
