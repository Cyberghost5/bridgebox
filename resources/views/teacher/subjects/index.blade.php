    ...
    <main class="main">
        <header class="topbar">
            <div class="greeting">
                ...
                <h1>Subjects</h1>
                <p class="subtext">Subjects available for your classes.</p>
            </div>
            <div class="actions">
                <a class="btn primary" href="{{ route('teacher.subjects.create') }}">Add Subject</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <a class="btn ghost btn-small" href="{{ route('teacher.subjects.edit', $subject) }}">Edit</a>
                                            <form method="post" action="{{ route('teacher.subjects.delete', $subject) }}" data-confirm="Delete this subject?" style="display:inline-block;">
                                                @csrf
                                                @method('delete')
