                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <a class="btn ghost btn-small" href="{{ route('teacher.assignments.submissions.show', [$assignment, $submission]) }}">Grade</a>
                                            @if ($submission->file_path)
                                                <a class="btn ghost btn-small" href="{{ route('teacher.assignments.submissions.download', [$assignment, $submission]) }}">Download</a>
                                            @endif
                                            <form method="post" action="{{ route('teacher.assignments.submissions.delete', [$assignment, $submission]) }}" data-confirm="Delete this submission?" style="display:inline-block;">
                                                @csrf
                                                @method('delete')
